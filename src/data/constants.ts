...
export const EXPERIENCE: Experience[] = [
  {
    ...
    startDate: "Jun 2024",
    endDate: "Nov 2024",
    title: "Programmer Analyst Trainee (Java Developer)",
    company: "Cognizant",
    description: [
      "Developed, tested, and debugged application modules to ensure functional accuracy and code reliability.",
      "Applied object-oriented programming concepts and database fundamentals to deliver practical project solutions.",
      "Identified and resolved logical, syntax, and runtime errors to improve overall code quality.",
      "Collaborated with team members following standard SDLC practices to ensure timely project delivery.",
    ],
    skills: [
      SkillNames.JS,
      SkillNames.REACT,
